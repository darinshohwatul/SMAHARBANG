...
function pinjamBuku($dataBuku) {
  ...
  $queryPinjam = "INSERT INTO peminjaman (id_buku, nisn, tgl_peminjaman, tgl_pengembalian) 
   VALUES('$id_buku', $nisn, '$tgl_peminjaman', '$tgl_pengembalian')";
...
function pengembalian($dataBuku) {
  ...
  $queryPengembalian = "INSERT INTO pengembalian VALUES(null, $idPeminjaman, '$idBuku', $nisn, '$bukuKembali', '$keterlambatan', $denda)";
