...
<aside id="sidebar" class="fixed top-0 left-0 z-40 w-64 h-full bg-blue-800 text-white transform -translate-x-full md:translate-x-0 transition-transform duration-300 ease-in-out">
  ...
  <nav class="flex flex-col p-4 space-y-3 text-sm">
        <a href="/e-learning/pages/siswa/dashboard.php" class="hover:bg-blue-700 p-2 rounded">🏠 Dashboard</a>
    <a href="/e-learning/pages/siswa/materi.php" class="hover:bg-blue-700 p-2 rounded">📚 Materi</a>
    <a href="/e-learning/pages/siswa/tugas.php" class="hover:bg-blue-700 p-2 rounded">📝 Tugas</a>
    <a href="/e-learning/pages/siswa/nilai.php" class="hover:bg-blue-700 p-2 rounded">⭐ Nilai</a>
    <a href="/e-learning/pages/siswa/forum.php" class="hover:bg-blue-700 p-2 rounded">💬 Forum</a>
    <a href="/e-learning/pages/siswa/pengumuman.php" class="hover:bg-blue-700 p-2 rounded">📢 Pengumuman</a>
    <a href="/e-learning/pages/siswa/profil.php" class="hover:bg-blue-700 p-2 rounded">👤 Profil</a>
